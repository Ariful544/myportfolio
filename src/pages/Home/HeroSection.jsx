            ...
            <motion.div
                ...
                <div className='space-y-3'>
                    <div className='dark:text-white flex gap-6 text-slate-950'>
                        <a className='text-2xl text-blue-600' href=''><FaFacebook /></a>
                        <a className='text-2xl text-blue-600' target='_blank' href='https://discord.com/channels/@me'><FaDiscord /></a>
                        <a className='text-2xl' target='_blank' href='https://github.com/Ariful544'><FaGithub /></a>
                        <a className='text-2xl text-blue-600' href=""><FaLinkedin /></a>
                    </div>
                </div>
